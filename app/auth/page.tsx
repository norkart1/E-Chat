...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-purple-50">
      <div className="bg-white rounded-3xl shadow-xl px-10 py-12 flex flex-col items-center gap-6 w-full max-w-sm">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500 text-sm mt-1">Sign in to start chatting with people</p>
        </div>

        {error && (
          <p className="text-red-500 text-sm text-center bg-red-50 rounded-xl px-4 py-2 w-full">{error}</p>
        )}
