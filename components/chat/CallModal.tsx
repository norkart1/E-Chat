    ...
    <div className="fixed inset-0 z-50 bg-gray-900 flex flex-col items-center justify-center select-none">
      ...
      <div className="absolute bottom-10 flex gap-4 items-center">
        <button
          ...
          className={`w-14 h-14 rounded-full flex flex-col items-center justify-center text-white shadow-lg transition-all ${muted ? "bg-red-500 hover:bg-red-600" : "bg-white/15 hover:bg-white/25 backdrop-blur-sm"}`}
        >
          {muted ? (
        ...
        <button
          onClick={endCall}
          title="End call"
          className="w-16 h-16 rounded-full bg-red-500 hover:bg-red-600 flex items-center justify-center text-white shadow-xl transition-all scale-110"
        >
        ...
        <button
          ...
          className={`w-14 h-14 rounded-full flex items-center justify-center text-white shadow-lg transition-all ${speakerOff ? "bg-red-500 hover:bg-red-600" : "bg-white/15 hover:bg-white/25 backdrop-blur-sm"}`}
        >
          <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            {speakerOff ? (
        ...
        {callType === "video" && (
          <button
            ...
            className={`w-14 h-14 rounded-full flex items-center justify-center text-white shadow-lg transition-all ${cameraOff ? "bg-red-500 hover:bg-red-600" : "bg-white/15 hover:bg-white/25 backdrop-blur-sm"}`}
          >
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
